...
know, that the proposed algorithm will not undermine the minimum capacity of
the edge $b$.
...
No, since we might need to move a tile, which will increase the heuristic
value, to get to our solution (see
...
\begin{figure}[htbp]
    ...
    \vskip 0.2cm
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/Exercise_2_8_h1_Monotonicity}
...
\begin{figure}[htbp]
    ...
    \vskip 0.2cm
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/Exercise_2_8_h2_Monotonicity}
